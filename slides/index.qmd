...
<ul> <li>Manages conversations, directories, worktrees seamlessly</li> <li>More threads of work across many more projects</li> <li>Blends all work together</li> <li>Git is a core technology</li> <li>Context management is the core challenge</li> <li class="fragment">... and quality</li> </ul>

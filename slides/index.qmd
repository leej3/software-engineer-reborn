...
- **Making — builders:** How can this be built?
- **Directing — coordinators:** What should be done, and in what order?
- **Deciding — leaders:** Which outcomes matter, and which risks are acceptable?
- **Connecting — communicators:** What will people understand, trust, value, or use?

::: {.notes}

These are overlapping dispositions, not exclusive job categories.
Most people combine them in different proportions.
Connecting includes listening, understanding people, and establishing shared purpose.

AI lets people from these different backgrounds reach into one another's work.
Engineers can take on more direction and domain work; domain experts and leaders can implement more of their own ideas.
Each brings strengths and has gaps to develop.

Source: Four Dispositions in talk-concepts/08-a-favorable-starting-position.md.

:::

## Types of software engineers {.engineer-types}

| Orientation | What they value | How they may need to grow |
|:---|:---|:---|
| **Craft** | Mastery, correctness, elegance, authorship | Extend craft into architecture, evaluation, and stewardship |
| **Systems** | Interfaces, dependencies, constraints, failure modes | Develop domain and product judgment |
| **Product** | User needs and useful outcomes | Deepen evaluation and reliability skills |
| **Operational** | Observability, resilience, recovery | Help define autonomy, control, and acceptable failure earlier |

::: {.notes}

These four orientations overlap; they are not a complete classification of engineers.

Craft provides a basis for judging generated work, but attachment to direct authorship can make the transition difficult.
Systems thinking helps make components dependable, but needs a connection to worthwhile human outcomes.
Product judgment helps choose what to build, but rapid production can be mistaken for reliable progress.
Operational judgment should shape design and the limits of autonomy, rather than being confined to downstream support.

Source: Different Engineers, Different Adaptations in talk-concepts/08-a-favorable-starting-position.md.

:::

## Future jobs for software engineers

- **Directing AI-assisted production:** specify work, guide agents, review results, and integrate changes.
- **Broader knowledge work:** use AI across domains to produce analyses, designs, and products.
- **Engineering AI systems:** build bounded, repeatable capabilities with evaluation and monitoring.
- **Conventional software engineering:** pursue technical depth where security and direct control matter.

::: {.notes}

These are the four previously identified directions, not four guaranteed future job titles.
They overlap, and none is insulated from further change.

Broader knowledge work may suit someone who enjoys unfamiliar domains and taking an idea further toward an outcome.
Directing production involves substantial specification, review, and empirical adjustment of agent behavior.
Engineering AI systems puts evaluation and operational reliability at the center of the work.
Conventional engineering remains a direction for people interested in technical depth and direct control; the tools used in that work can still change with AI.

Source: slide 10 of talk-candidates/02-choosing-the-work-again.md.

:::

## How does one choose a role? {.role-factors}

- **Enjoyment:** daily activities, immersion, creativity, satisfaction.
- **Mastery:** strengths, technical depth, learning, direct authorship.
- **Impact:** useful outcomes, purpose, values, people affected.
- **Compensation:** income, benefits, financial needs, stability.
- **Lifestyle:** hours, flexibility, location, workload, energy, family.
- **Community:** colleagues, collaboration, belonging, mentorship.
- **Agency:** autonomy, influence, ownership, responsibility.
- **Practical fit:** available opportunities, experience, career stage, cost of retraining.

::: {.notes}

The original factors were impact, compensation, enjoyment, lifestyle, community, and agency.
Mastery and practical fit make explicit the other considerations in the professional-identity and career-choice notes.
The examples expand each factor into questions someone can apply to their own circumstances.

Ask what the working day actually involves, not only whether the title or output is appealing.
Greater capability can coexist with less satisfaction or greater cognitive exhaustion.
Preferences can change with experience and stage of life, and people have different constraints on their choices.

Sources: talk-concepts/03-rebuilding-professional-identity.md and talk-candidates/02-choosing-the-work-again.md.

:::

## The role has changed... pick a new one

- The old role can be dead even if the job title survives.
- Change with AI: develop toward the work you want to do with it.
- Or choose a different niche that better fits your interests and preferences.
- Rebirth means choosing what comes next, rather than expecting the old job back.

::: {.notes}

This is the sense in which I mean the software engineer is reborn.
The work can change enough to become a different role, even when employers keep calling it software engineering.
The question is whether I want that role and, if so, which version of it.

Changing direction can mean adapting within the current profession or finding a niche with a different balance of activities, depth, autonomy, and human collaboration.
Accumulated experience informs that choice, but does not require preserving the same professional identity or daily work.

The claim concerns the role and its appeal, not a prediction that every software engineering position has disappeared.
Close directly on choosing work that fits the person's preferences under the changed conditions.

:::

## Dealing with the change {.closing-agency}

::: {.closing-alternatives}

**Denial** · This will not fundamentally change me.

**Surrender** · Nothing I choose will matter.
...
I cannot know the outcome, but I can still participate deliberately in determining what happens next.

:::

::: {.closing-resources}

[GitHub repository ↗](https://github.com/leej3/software-engineer-reborn) · [Prep site & exploration notes ↗](https://software-engineer-reborn-atlas.johnlee3728739.chatgpt.site)

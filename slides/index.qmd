...
riffing on previous talk explore some of the latests updates and future directions this is an exploration of what the path forward looks like for those who until recently were known software engineers :::


## Overview

- How I got here
- AI is good at doing stuff
- Software engineers are good at using AI
- It's hard to assess the quality of the output of AI
- What are the roles of the future?
...
## What else {.image-memory}

![](images/future-work.png){.support-illustration .nostretch fig-alt="A person and robotic assistant collaborating in a future workspace."}
...
<span class="quote-mark quote-open">“</span>This invention will produce forgetfulness in the minds of those who learn to use it, because they will not practice their memory …

:::

::: {.fragment fragment-index="2"}

the appearance of wisdom, not true wisdom<span class="quote-mark quote-close">”</span>
...
of course it changes the brain. everything does software engineering does socrates' lamemt

:::

## What else {.image-possibility}

![](images/engineer-possibility.png){.support-illustration .nostretch fig-alt="An engineer building a small mechanical world at a workbench."}

- Cognitive distortions: We can't tell the future, we are prone to catastrophizing, we forget how capable we are.
...
## Even when the code is invisible, knowing computer science still helps. {.cs-evidence .image-evidence}

![](images/invisible-code.png){.support-illustration .nostretch fig-alt="A person examining the inner mechanisms of a device."}
...
## How does one measure quality? {.image-quality}

![](images/blind-assessment.png){.support-illustration .nostretch fig-alt="A reviewer compares a working bridge design with an attractive bridge that fails to span the gap."}
...
## Operationalizing quality assessment

Task → requirements → quality dimensions → observable criteria → evaluator → metric
...
- **Engineers** can take on more domain and product work.
  They need to understand which outcomes matter.
- **Domain experts and leaders** can implement more of their own ideas.
  They need to distinguish a convincing result from a dependable system.
- Both need to judge whether the work is useful and whether it can be relied on.

::: {.notes}

AI lowers barriers in both directions.
Engineers bring experience with systems and failure; people from other backgrounds bring knowledge of users, institutions, and real-world needs.
Neither starting point supplies everything.
This is convergence in the work people can attempt, not a claim that everyone becomes interchangeable or that all professions merge into one role.

Source: talk-concepts/02-converging-expertise-and-system-correctness.md.

:::

## Making, directing, deciding, connecting

- **Builders / making:** How can this be built?
- **Directors / directing:** What should be done, and in what order?
- **Deciders / deciding:** Which outcomes matter, and which risks are acceptable?
- **Communicators / connecting:** What will people understand, trust, value, or use?

::: {.notes}

These are overlapping contributions, not four separate job titles.
People combine them in different proportions.
Connecting includes listening, understanding people, and establishing shared purpose as well as explaining the work.

Engineers have often been identified most strongly with making.
AI creates opportunities to take on more of the other contributions, while people who already direct, decide, or communicate can increasingly build.
No one has to develop all four equally.

Source: the Four Dispositions section of talk-concepts/08-a-favorable-starting-position.md.

:::

## A changed working day

- More work defining objectives and constraints.
- More direction and assessment of generated work.
- More integration across technical and domain boundaries.
- Less direct implementation in some roles.

::: {.notes}

The title can survive while the day-to-day work changes substantially.
The balance will differ by project and organization, but learning an AI tool may be only a small part of adapting to the job.

In my own work I can take an idea further across the stack, while spending more attention on context, decisions, and assessing unfamiliar output.
Someone who chose engineering for sustained implementation work may not enjoy the resulting job equally, even if they are good at it.

Source: talk-concepts/03-rebuilding-professional-identity.md.

:::

## Craft and systems orientations
...
Values mastery, correctness, elegance, and direct authorship.

**Strength:** judging technical quality.

**Develop toward:** architecture, evaluation, and stewardship.
Decide how much hands-on implementation you want to retain.
...
Thinks in interfaces, dependencies, constraints, and failure modes.

**Strength:** making components work together dependably.

**Develop:** domain and product judgment to connect system design to worthwhile outcomes.
...
These orientations overlap and are not an exhaustive taxonomy.
A person may recognize themselves in several of them.

The craft-oriented engineer has a strong basis for judging generated work, but may find the loss of direct authorship difficult.
Extending craft does not require pretending that implementation no longer matters or that its satisfaction is easily replaced.

The systems engineer can contribute to dependable AI capabilities, but needs to understand which human outcome the machinery should serve.

Source: Different Engineers, Different Adaptations in talk-concepts/08-a-favorable-starting-position.md.

:::

## Product and operational orientations
...
Values solving user problems and delivering useful outcomes.

**Strength:** connecting implementation to purpose.

**Develop:** evaluation and reliability skills so rapid production leads to dependable progress.
...
Values observability, resilience, repeatability, and recovery.

**Strength:** understanding systems in use.

**Develop toward:** earlier involvement in decisions about autonomy, control, and acceptable failure.
...
Product-oriented engineers may already span the boundary between what should be built and how it works.
The risk is accepting plausible, rapidly produced work before there is sufficient evidence that it meets the need reliably.

Operational engineers bring useful instincts when systems can take actions.
Their contribution should help shape the system before deployment, rather than being confined to supporting decisions already made.

These are directions for development, not predictions of protected jobs.
Source: Different Engineers, Different Adaptations in talk-concepts/08-a-favorable-starting-position.md.
...
- Which activities do you enjoy, and which would you miss?
- Where do you want to develop depth?
- How do you weigh impact, compensation, lifestyle, and community?
- What responsibility do you want to take on?

::: {.notes}

Greater capability does not automatically mean greater satisfaction.
In my experience, broader output has come with less retained detail, some lost pleasure in solving the problem personally, and a different kind of exhaustion.
Quality is not the same as ownership: an artifact may be better while remaining harder for me to explain or stand behind.

Use these personal observations to make the choice concrete, without assuming everyone experiences the change in the same way.
The things we want from work can also change with our stage of life.

Sources: talk-concepts/03-rebuilding-professional-identity.md and talk-candidates/02-choosing-the-work-again.md.

:::

## Developing in your chosen direction

- Identify the work you want more of.
- Work out which knowledge and experience it requires.
- Seek projects and responsibilities that develop those strengths.
- Build relationships with people whose expertise complements yours.

::: {.notes}

Choosing intentionally can mean changing the balance of work within a current role as well as moving to a different one.
For example, a systems engineer interested in product work could participate in user conversations and defining success, rather than only receiving an implementation specification.
An operational engineer could seek involvement in design decisions about autonomous actions and recovery.

The point is to make development choices based on the work you want to do, rather than assuming that retaining the title will preserve the job you originally chose.

Sources: talk-concepts/08-a-favorable-starting-position.md and talk-candidates/02-choosing-the-work-again.md.
